...
- Infoblocks for Internet Banking and Instalment payments (PR [#185](https://github.com/omise/omise-magento/pull/185))
...
- Adds required code to fix order emails not being sent in all 'redirect' scenarios (PR [#159](https://github.com/omise/omise-magento/pull/159))
- Fixes issue with orders not being updated after an order 'cancelled' by closing browser tab/window (PR [#156](https://github.com/omise/omise-magento/pull/156))
