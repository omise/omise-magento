...
class Offsite extends Action
{
    ...
    private function handleSuccess($order, $chargeId, $payment, $paymentMethod)
    {
        ...
        $payment->addTransactionCommentsToOrder(
            ...
            __(
                "Amount of %1 has been paid via Omise Payments $paymentMethodLabel payment",
    ...
    private function handlePending($order, $payment)
    {
        ...
        $payment->addTransactionCommentsToOrder(
            ...
            the processing has been updated (check the result on the Omise Payments Dashboard).')
        );
